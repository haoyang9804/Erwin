...
/**
 * Test the validity of the programs in the output directory generated by Erwin.
 * 
 * @returns 0 if all the programs in the "generated_programs" directory are valid
 * @returns 1 if any of the programs in the "generated_programs" directory triggers an error
 * @returns 2 if the "generated_programs" directory does not exist
 */
export async function test_validity() : Promise<number> {
  try {
    ...
    console.error('Error in test validity:', err);
    return 2;
  }
}