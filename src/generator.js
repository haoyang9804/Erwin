import { ASTNodeFactory, ContractKind, FunctionKind, FunctionVisibility, FunctionStateMutability, DataLocation, StateVariableVisibility, Mutability, LiteralKind } from "solc-typed-ast";
class Generator {
    constructor() {
