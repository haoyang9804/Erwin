...
import { varID2Types, ElementaryType, all_integer_types, all_elementary_types, all_function_types } from "../src/type"
...
() => {
  ...
  varID2Types.set(0, all_function_types);
  varID2Types.set(1, all_function_types);
